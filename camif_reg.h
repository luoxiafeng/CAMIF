...
** 
** Soc camif of infotm Q3 register defination header file for Q3 camif soc verification    
**
** Revision History: 
** ----------------- 
** v1.0.1	sam@2014/10/16: first version.
**
*****************************************************************************/
...
#include <asm/arch-apollov/base-map.h>

//define csi register operation macro
#define camif_write(_host, _offset, _val) csi_write(_host, _offset, _val) 
#define camif_read(_host, _offset) csi_read(_host, _offset)
#define 	CAMIF_DMA_BUF_LEN 	(1920*1080*2)//(1024*1024*8)	
#define		CAMIF_DMA_BUF_LEN_PREV (1920*1080*3)

//define camif base register
#define IMAPX_CAMIF_REG_BASE		(CAMIF_BASE_ADDR)
#define SYSMGR_CAMIF_BASE			(CAMIF_SYSM_ADDR)

#define		CAMIF_CISRCFMT			(0x0000)
#define		CAMIF_CIWDOFST			(0x0004)
#define		CAMIF_CIGCTRL			(0x0008)
#define		CAMIF_CIPRIOCFG			(0x0010)//apollo-v new
#define		CAMIF_CICOTRGSIZE		(0x0044)
#define		CAMIF_CICOTRGFMT		(0x0048)
#define		CAMIF_CIPRTRGSIZE		(0xffff)//apollo-v not exist
#define		CAMIF_CIPRTRGFMT		(0x007C)
#define		CAMIF_CIPRSCPRERATIO	(0xffff)//apollo-v not exist
...
#define 	CAMIF_INPUT_SUMPIXS		(0xffff)//apollo-v not exist
#define 	CAMIF_ACTIVE_SIZE		(0xffff)//apollo-v not exist
...
#define		CAMIF_SCALER_IN_SIZE	(0x1000)
#define		CAMIF_SCALER_OUT_SIZE	(0x1004)
#define		CAMIF_SCALER_SRC_HRTIO  (0x1008)
#define		CAMIF_SCALER_SRC_VRTIO  (0x100c)
#define		CAMIF_SCALER_CTL		(0x1010)
#define		CAMIF_SCALER_LAZIR		(0x1014)
#define		CAMIF_SCALER_LAZOR		(0x1018)
#define		CAMIF_SCALER_PIXCNT_IN  (0x111c)
#define		CAMIF_SCALER_PIXCNT_OUT (0x1120)

#define		CAMIF_SCALER_COE_START	(0X101C)
#define		CAMIF_SCALER_COE_END	(0X1118)
#define		CAMIF_SCALER_COE_COUNT  (64)
...
#define CAMIF_CH3DMA_FB(x)			(CAMIF_CH3DMAFB1 + 0x8 * x)                   
#define CAMIF_CH4DMA_FB(x)			(CAMIF_CH4DMAFB1 + 0x8 * x)                   
...
#define CAMIF_CH3DMA_CC(x)			(CAMIF_CH3DMACC1 + 0x8 * x)
#define CAMIF_CH4DMA_CC(x)			(CAMIF_CH4DMACC1 + 0x8 * x)

//############################bit offset#######################################
//scaler
#define SCALER_IN_H_SIZE_SHIFT		(0)
#define SCALER_IN_V_SIZE_SHIFT		(16)
#define SCALER_OUT_H_SIZE_SHIFT		(0)
#define SCALER_OUT_V_SIZE_SHIFT		(16)
#define SCALER_RATIO_INT_P_H		(13)
#define SCALER_RATIO_DEC_P_H		(0)  //decimal
#define SCALER_RATIO_INT_P_V		(13)
#define SCALER_RATIO_DEC_P_V		(0)  //decimal
#define SCALER_BY_PASS				(1)
#define SCALER_EN					(0)
#define SCALER_IN_RSL_CNT_H			(0)
#define SCALER_IN_RSL_CNT_V			(16)
#define SCALER_OUT_RSL_CNT_H		(0)
#define SCALER_OUT_RSL_CNT_V		(16)

//CISRCFMT
#define	CISRCFMT_ITU601or656		(30)
#define	CISRCFMT_UVOffset			(29)
#define	CISRCFMT_ScanMode			(28)
